...
void Context::Render(ID3D11DeviceContext *context, uint32_t width, uint32_t height) {
    ...
    // -------------------------------------------------------
    {
        ...
        // t10: 누적 버퍼를 SRV로 읽기
        ID3D11ShaderResourceView *tmSRVs[1] = { m_accumSRV.Get() };
